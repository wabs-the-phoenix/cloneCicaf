...
INSERT INTO `entreprise` (`idEntreprise`, `SCodeEntreprise`, `SNomEntreprise`, `RespoEntreprise`, `TypeEntreprise`, `SNumRue`, `SNomRue`, `SNumTel`, `NumEmail`, `DDebutActivite`, `DDComptabilite`, `entitede`, `commune_idCommune`, `NIF`, `NbreJourTravailParSemaine`, `NbreHeureDeTravailParJour`, `status`) VALUES
(4, '001', 'Sertek plus', 'Josue KALUBI', 'service', '213b', 'Shaumba', '085 22 54 236', 'sertek@gmail.com', '2018-02-05 00:00:00', '2020-05-06 00:00:00', NULL, 1, 'f256-565', 5, 8, 1),
(5, '251', 'Sertek-kin', 'Richard van', 'sarlu', '213b', 'ethip', '085 58 69 236', 'seffgrtek@gmail.com', '2018-02-05 00:00:00', '2020-05-06 00:00:00', 4, 2, NULL, 5, 8, 1),
(28, '2556', 'Vodacom', 'Eli&eacute;', 'service', '56', 'Haut Huele', '08255455255', 'sqm@gmail.com', '2021-10-29 00:00:00', '2021-10-29 00:00:00', NULL, 3, 'dddd', 6, 6, 1),
(39, '00567', 'Sertek Gom&eacute;', 'herve', NULL, '56', 'Haut Huele', '08255455255', NULL, NULL, NULL, 4, 4, NULL, NULL, NULL, 1),
(46, '002', 'Microcom', 'Berthe', 'vente service internet', '56', 'kabasele', '0990252541', 'microcom@gmail', '2021-11-04 00:00:00', '2021-11-04 00:00:00', NULL, 1, 'fghde', 5, 5, 1),
(47, '161651', 'gh', 'dphhghjjh', 'vente service internet', '56', 'Haut Huele', '0990252541', 'sqm@gmail.com', '2022-01-21 00:00:00', '2022-02-05 00:00:00', NULL, 3, 'ffff', 5, 5, 1),
(48, '2165456', 'gh', 'david', 'service', '56', 'Haut Huele', '08255455255', 'airtel@gmail.com', '2022-01-14 00:00:00', '2022-01-20 00:00:00', NULL, 3, 'lkmlkmlkm', 6, 5, 1),
(49, 'zddzd', 'gh', 'samd', 'service', '21j', 'Haut Huele', '08255455255', 'sqm@gmail.com', '2022-01-06 00:00:00', '2022-02-03 00:00:00', NULL, 1, 'ww', 6, 5, 1),
(50, '656456465', 'dplic', 'samd', 'service', '21j', 'Haut Huele', '08255455255', 'sqm@gmail.com', '2022-01-04 00:00:00', '2022-01-14 00:00:00', NULL, 1, 'ffff', 5, 4, 1);
...
INSERT INTO `user` (`idUser`, `nom`, `login`, `mpd`, `specialCode`, `entrepriseId`, `agentId`, `role`, `email`) VALUES
(1, 'samuel kem', 'sam', '4e19302af21c1b0ec7a3d1f151ac4b2a9ed4b986', NULL, NULL, NULL, 'admin', NULL);
...
INSERT INTO `userpermission` (`idUserPermission`, `adminRead`, `adminWrite`, `comptaRead`, `comptaWrite`, `budgetRead`, `budgetWrite`, `personnelRead`, `personnelWrite`, `amortissementRead`, `amortissementWrite`, `entrepriseRead`, `entrepriseWrite`, `userId`, `manageAdmin`) VALUES
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_user_agent` FOREIGN KEY (`agentId`) REFERENCES `agent` (`idAgent`),
